...
avr_mark(Subject, Result):-
	findall(X, grade(_,_,Subject,X), R),
	sumlist(R, Sum),
	mylen(R, Len),
	Result is Sum/Len.


% найти количество несдавших в группе

neudGroup(Group, Kol):-
	findall(Group, grade(Group, _, _, 2), R),
	mylen(R, Kol).
% количество несдавших для каждого из предметов

neudSubject(Subject, Kol):-
	findall(Subject, grade(_, _, Subject, 2), R),
	mylen(R, Kol).

% решение
first:-
	avr_mark('Логическое программирование', R1), write("avr log: "), write(R1), nl,
	avr_mark('Математический анализ', R2), write("avr math: "), write(R2), nl,
	avr_mark('Функциональное программирование', R3), write("avr func: "), write(R3), nl,
	avr_mark('Информатика', R4), write("avr inf: "), write(R4), nl,
	avr_mark('Английский язык', R5), write("avr eng: "), write(R5), nl,
	avr_mark('Психология', R6), write("avr psy: "), write(R6), nl.

second:-
	neudGroup(101, R1), write("neud 101: "), write(R1), nl,
	neudGroup(102, R2), write("neud 102: "), write(R2), nl,
	neudGroup(103, R3), write("neud 103: "), write(R3), nl,
	neudGroup(104, R4), write("neud 104: "), write(R4), nl.

third:-
	neudSubject('Логическое программирование', R1),  write("neud log: "), write(R1), nl,
	neudSubject('Математический анализ', R2), write("neud math: "), write(R2), nl,
	neudSubject('Функциональное программирование', R3),  write("neud func: "), write(R3), nl,
	neudSubject('Информатика', R4),  write("neud inf: "), write(R4), nl,
	neudSubject('Английский язык', R5),  write("neud eng: "), write(R5), nl,
	neudSubject('Психология', R6),  write("neud psy: "), write(R6), nl.
